...
public class TestObjects {
    ...
    public static Rating rating= RatingFactory.createRating(4,movie,user);
    public static Snack snack=SnackFactory.createSnack(50,"popcorn");
    ...
    public static Ticket ticket=TicketFactory.createTicket(200,seat,user,movie);
